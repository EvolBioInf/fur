...
saves both time and memory. For detailed measurements on this, please
take a look at the program \ty{stream}, which is also part of this
package. Before we calculate the ESA from the forward strand, we
